...
namespace FahrradladenPrinzenstrasse.Mobile.ViewModels.KupiOpremu
{
    /// <summary>
    ...
    public class CatalogPageViewModel : BaseViewModel
    {
        ...
        private void ItemSelected(object attachedObject)
        {
            ...
            if (prod != null)
                Navigation.PushAsync(new Views.DetaljiOprema.DetailPage(prod));
        }
        ...
        private void SortClicked(object obj)
        {
            if (obj is SfButton btn)
            {
                ...
                popupView.ShowSortingPopUp("Zatvori", btn, this.SortOptions, request, UcitajOpremu);
            }
        }
