...
namespace FahrradladenPrinzenstrasse.Mobile.ViewModels.IznajmiBicikl
{
    /// <summary>
    ...
    public class CatalogPageViewModel : BaseViewModel
    {
        ...
        public CatalogPageViewModel(INavigation navigation)
        {
            ...
            request.SamoIznajmljivanje = true;
        ...
        private async void ItemSelected(object attachedObject)
        {
            ...
            if (prod != null)
                await Navigation.PushAsync(new Views.DetaljiIznajmiBicikl.DetailPage(prod));
        }
