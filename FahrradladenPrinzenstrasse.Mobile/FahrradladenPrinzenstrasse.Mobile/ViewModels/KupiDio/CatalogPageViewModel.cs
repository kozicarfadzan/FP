...
namespace FahrradladenPrinzenstrasse.Mobile.ViewModels.KupiDio
{
    /// <summary>
    ...
    {
        private readonly APIService _serviceDio = new APIService("Dio");
        ...
        private Model.Requests.DioSearchRequest request = new Model.Requests.DioSearchRequest();
        ...
        public async Task UcitajDio()
        {
            var list = await _serviceDio.Get<List<Model.Dio>>(request);
            Products.Clear();
        ...
        private void ItemSelected(object attachedObject)
        {
            ...
            if (prod != null)
                Navigation.PushAsync(new Views.DetaljiDio.DetailPage(prod));
        }
        ...
        private void SortClicked(object obj)
        {
            if (obj is SfButton btn)
            {
                ...
                popupView.ShowSortingPopUp("Zatvori", btn, this.SortOptions, request, UcitajDio);
            }
        }
        ...
        private void FilterClicked(object obj)
        {
            ...
            {
                SfPopupView popupView = new SfPopupView();
                popupView.ShowFilterPopUp("Zatvori", btn, this.FilterOptions, request, UcitajDio);
            }
        }
