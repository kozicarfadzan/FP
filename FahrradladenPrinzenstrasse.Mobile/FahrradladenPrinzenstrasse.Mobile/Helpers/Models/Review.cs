...
namespace FahrradladenPrinzenstrasse.Mobile.Models
{
    ...
    public class Review
    {
        ...
        {
            get { return App.BaseBiciklImageUrl + this.customerImage; }
        ...
        public List<string> Images
        {
            get
            {
                if (images != null)
                {
                    ...
                    {
                        this.images[i] = this.images[i].Contains(App.BaseBiciklImageUrl) ? this.images[i] : App.BaseBiciklImageUrl + this.images[i];
                    }
                }
                return this.images;
            }
