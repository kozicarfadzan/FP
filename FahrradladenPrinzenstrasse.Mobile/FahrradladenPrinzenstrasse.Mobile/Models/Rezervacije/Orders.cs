...
namespace FahrradladenPrinzenstrasse.Mobile.Models.Rezervacije
{
    /// <summary>
    ...
    public class Orders
    {
        ...
        /// <summary>
        /// Gets or sets the property that has been bound with a label, which displays the total price.
        /// </summary>
        [DataMember(Name = "totalprice")]
        public double TotalPrice { get; set; }

        public bool IsPlatiButtonVisible { get => Status == "Čekanje uplate";  }
        #endregion
    }
}
