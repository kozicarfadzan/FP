...
using FahrradladenPrinzenstrasse.Mobile.ViewModels.KupiBicikl;
using Xamarin.Forms.Internals;

namespace FahrradladenPrinzenstrasse.Mobile.DataService
{
    /// <summary>
    ...
    public class CatalogDataService
    {
        ...
        {
            var file = "FahrradladenPrinzenstrasse.Mobile.Data." + fileName;
