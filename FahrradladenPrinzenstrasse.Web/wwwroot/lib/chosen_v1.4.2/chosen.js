        ...
        Chosen.prototype.set_up_html = function() {
            ...
            if (this.is_multiple) {
                if (this.display_selectall_option) {
                    this.container.html('<ul class="chosen-choices"><li class="search-field"><input type="text" value="' + this.default_text + '" class="default" autocomplete="off" style="width:25px;" /></li></ul><div class="chosen-drop"><div class="selectallSection"><span>Select All</span></div><ul class="chosen-results"></ul></div>');
                } else {
