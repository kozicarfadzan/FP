...
namespace FahrradladenPrinzenstrasse.Data.Migrations
{
    ...
    [Migration("20201226190913_Notifikacija_AddRezervacijaColumns")]
    partial class Notifikacija_AddRezervacijaColumns
    {
            ...
            modelBuilder.Entity("FahrradladenPrinzenstrasse.Data.EntityModels.Notifikacija", b =>
                {
                    ...
                    b.HasIndex("RezervacijaProdajaBiciklaID");

                    b.HasIndex("RezervacijaProdajaDioId");

                    b.HasIndex("RezervacijaProdajaOpremaId");

                    b.HasIndex("RezervacijaServisId");
            ...
            modelBuilder.Entity("FahrradladenPrinzenstrasse.Data.EntityModels.Notifikacija", b =>
                {
                    ...
                    b.HasOne("FahrradladenPrinzenstrasse.Data.EntityModels.RezervacijaProdajaBicikla", "RezervacijaProdajaBicikla")
                        .WithMany()
                        .HasForeignKey("RezervacijaProdajaBiciklaID");

                    b.HasOne("FahrradladenPrinzenstrasse.Data.EntityModels.RezervacijaProdajaDio", "RezervacijaProdajaDio")
                        .WithMany()
                        .HasForeignKey("RezervacijaProdajaDioId");

                    b.HasOne("FahrradladenPrinzenstrasse.Data.EntityModels.RezervacijaProdajaOprema", "RezervacijaProdajaOprema")
                        .WithMany()
                        .HasForeignKey("RezervacijaProdajaOpremaId");

                    b.HasOne("FahrradladenPrinzenstrasse.Data.EntityModels.RezervacijaServis", "RezervacijaServis")
                        .WithMany()
                        .HasForeignKey("RezervacijaServisId");
