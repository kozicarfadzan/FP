...
using FahrradladenPrinzenstraße.Mobile.Views.DetaljiOprema;
using FahrradladenPrinzenstraße.Mobile.Views.Korpa;
using Microsoft.EntityFrameworkCore.Metadata.Internal;
using Xamarin.Forms;
using Xamarin.Forms.Internals;

namespace FahrradladenPrinzenstraße.Mobile.ViewModels.DetaljiOprema
{
    /// <summary>
    ...
    public class DetailPageViewModel : BaseViewModel
    {
        ...
        private async Task VariantClicked()
        {
            ...
            if (list.Count == 0)
            {
                await Application.Current.MainPage.DisplayAlert("Greška", "Nije pronađena oprema", "OK");
                return;
            }
